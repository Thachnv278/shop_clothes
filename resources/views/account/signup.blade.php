      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover mx-auto">
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a href="{{asset('/')}}" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuBlocks" >
              Trang chủ
              
            </a>
          </li>
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a href="{{asset('signin')}}"  class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuEcommerce" >
              Đăng nhập
            </a>
          </li>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <form role="form text-left" action="{{route('addUser')}}" method="POST">
                 @csrf
                <div class="mb-3">
                ...
                <div class="text-center">
                  <a href = ""><button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Đăng Kí</button></a>
                </div>
