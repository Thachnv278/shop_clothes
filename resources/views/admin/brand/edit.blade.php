       ...
       <div class="card mb-4">
         ...
         <div class="card-body px-0 pt-0 pb-2">
           <div class="table-responsive p-0">
             <form action="{{route('editBrand',['id'=>$Brand->id])}}" method="POST"  enctype="multipart/form-data" >
               @csrf
               <div class="mb-3 ms-3 px-3">
                ...
                <div class="form-group mb-3 ms-3 px-3">
                  ...
                  <div class="col-md-9 col-sm-8">
                      <div class="row">
                          <div class="col-xs-6">
                              <img id="mat_truoc_preview" src="{{$Brand->logo ?''.Storage::url($Brand->logo):''}}" alt="your image"
               ...
               <a href="{{ route('listBrand') }}"> <button type="button" class="btn btn-primary"> Danh Sách </button></a>
                 </div>
              </form>
           </div>
         </div>
