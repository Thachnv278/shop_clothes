...
<div class="container-fluid py-4">
   ...
   <div class="row">
     <div class="col-12">
               ...
               <tbody>
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                    <a href="{{ route('editCategory',['id'=>$Category->id]) }}"> <button class="btn bg-gradient-primary  mb-2 ms-2" data-class="bg-white" >Sửa</button></a>
                    <a href="{{ route('deleteCategory',['id'=>$Category->id]) }}"> <button class="btn bg-gradient-primary  mb-2 ms-2" data-class="bg-white" >Xóa</button></a>
                  </td>
                </tr>
              </tbody>
       ...
       <a href="{{ route('addCategory') }}"><button type="button" class="btn btn-primary"> Thêm danh mục</button></a>
       <hr>
     </div>
   </div>
